...
:::note
After partition leadership rebalancing, Redpanda could change the node that's uploading to cloud storage.
:::
...
| `cloud_storage_api_endpoint` | AWS or GCS API endpoint. <br/>- For AWS, this can be left blank. It’s generated automatically using the region and bucket. <br/>- For Google Cloud Service, use `storage.googleapis.com`. |
