...
| redpanda_cloud_client_not_found | Number of requests that came back empty from cloud storage. | --- | --- |
| redpanda_cloud_client_throttled | Number of client requests that were throttled. | --- | --- |
| redpanda_cloud_storage_upload_backoff | Number of upload requests that backed off. | --- | --- |
| redpanda_cloud_storage_download_backoff | Number of download requests that backed off. | --- | --- |
